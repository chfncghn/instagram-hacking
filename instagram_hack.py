...
class FaceBoom(object):
    ...
    def login(self,target, password):
        ...
        try:
            self.br.open("https://www.instagram.com")
    ...
    def banner(self,target,wordlist,single_passwd):
        ...
        print(gr+"""
===========================================
[---]        """+wi+"""Instagram_Hacking"""+gr+"""     [---]
===========================================
[---]      """+wi+"""BruteForce instagram   """+gr+""" [---]
===========================================
[---]         """+yl+"""Attack Started"""+gr+"""       [---]
===========================================
[>] Target      :> """+wi+target+gr+"""
...
def Main():
   ...
   parse.add_option("-g","-G","--getid","--GETID",dest="url",type="string",
                        help="Specify TARGET INSTAGRAM PROFILE URL to get his ID")
